#!/bin/bash
# -----------------------------------------------------------------------------
# M13 NODE "TITAN CLIENT" - PHYSICS ENGINE v0.4.1
# TARGET: Linux Edge Devices (x86_64 / ARM64)
# FIXES: Adaptive RX (True), NAPI, IRQ Pinning, Buffers, Firewall, BBR, WiFi
# -----------------------------------------------------------------------------
...
echo ">>> ENGAGING TITAN CLIENT PROTOCOLS FOR $INTERFACE..."
...
if command -v iw >/dev/null 2>&1; then
    ...
    echo "    -> WARNING: 'iw' binary missing. Skipping Radio Optimization."
fi
